...
import { DeckGLGoogleOverlay } from '@/features/map-engine/providers/google/DeckGLGoogleOverlay'
...
type GoogleMapsDeckRouteOverlayProps = {
  map: google.maps.Map | null
  mapIdDefined: boolean
  panel: WorkspacePanelId
  projectId: string | null
  enabled: boolean
}

export function GoogleMapsDeckRouteOverlay({
  map,
  mapIdDefined,
  panel,
  projectId,
  enabled,
}: GoogleMapsDeckRouteOverlayProps) {
